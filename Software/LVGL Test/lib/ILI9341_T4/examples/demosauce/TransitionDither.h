...
void TransitionDither::init(ILI9341Wrapper & tft) {

}

void TransitionDither::restart(ILI9341Wrapper & tft, uint_fast16_t inColor ) {
...
void TransitionDither::perFrame(ILI9341Wrapper & tft, FrameParams frameParams ) {
