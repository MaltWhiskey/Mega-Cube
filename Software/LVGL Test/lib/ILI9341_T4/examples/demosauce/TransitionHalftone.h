...
void TransitionHalftone::init(ILI9341Wrapper & tft) {

}

void TransitionHalftone::restart(ILI9341Wrapper & tft, uint_fast16_t inColor ) {
...
void TransitionHalftone::perFrame(ILI9341Wrapper & tft, FrameParams frameParams ) {
