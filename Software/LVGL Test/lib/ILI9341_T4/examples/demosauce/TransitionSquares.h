...
void TransitionSquares::init(ILI9341Wrapper & tft) {

}

void TransitionSquares::restart(ILI9341Wrapper & tft, uint_fast16_t inColor ) {
...
void TransitionSquares::perFrame(ILI9341Wrapper & tft, FrameParams frameParams ) {
