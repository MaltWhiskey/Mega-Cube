 ...
 *-------------------------------------------------------------------------------------*/
static inline uint8_t map8(uint8_t in, uint8_t inMin, uint8_t inMax, uint8_t outMin, uint8_t outMax) {
  if(outMax > outMin)
...
static inline float mapf(float in, float inMin, float inMax, float outMin, float outMax) {
